  ...
  const projects = [
    {
      name: "Business Card",
      description:
        "Сайт-визитка команды SemgaTeam. Написан на React. Дизайн + код: <b>losion</b>",
    ...
    },
    {
      name: "Messenger",
      description:
        "Мессенджер команды SemgaTeam. Разработчики: <b>losion</b>, <b>dmx</b>.",
      demo: "",
    ...
    },
    {
      name: "Demo Project",
      description:
        "Учебный проект наших стажеров: Мини социальная сеть. Разработчики: <b>jisys</b>, <b>sheva</b>.",
      demo: "",
